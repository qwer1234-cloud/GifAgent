...
hiddenimports += [
    ...
    "app.pipeline.config",
    "app.pipeline.direct",
    "app.pipeline.export_gif",
    "app.pipeline.prompts",
    "app.pipeline.quality_bridge",
    "app.pipeline.ranking",
    "app.pipeline.scoring",
    "app.pipeline.stage_io",
    "app.pipeline.stages",
    "app.pipeline.stages.discover",
    "app.pipeline.stages.gif_clip",
    "app.pipeline.stages.materialize",
    "app.pipeline.stages.rank_dedup",
    "app.pipeline.stages.refine",
    "app.pipeline.stages.sample",
    "app.pipeline.stages.synthesize",
    "app.pipeline.stages.vlm",
    "app.pipeline.timing",
    "app.pipeline.vlm_runtime",
    "app.quality_moe",
