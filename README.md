...
- **向量索引**：基于 nomic-embed-text 的 FAISS 语义向量库，支持文本到 GIF 的跨模态检索（1062 向量 / 9221 媒体）
...
ollama pull hf.co/unsloth/Qwen3-14B-GGUF:Q4_K_M          # LLM 文本合成（简称 Qwen3-14B）
...
| LLM | `hf.co/unsloth/Qwen3-14B-GGUF:Q4_K_M`（简称 Qwen3-14B） | 综合标注 + 标签生成 |
